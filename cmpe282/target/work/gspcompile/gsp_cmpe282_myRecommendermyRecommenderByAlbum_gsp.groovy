...
class gsp_cmpe282_myRecommendermyRecommenderByAlbum_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/myRecommender/myRecommenderByAlbum.gsp" }
public Object run() {
Writer out = getOut()
...
invokeTag('link','g',62,['controller':("MyRecommender"),'action':("myRecommenderByGenre")],2)
printHtmlPart(24)
createClosureForHtmlPart(25, 2)
invokeTag('link','g',63,['controller':("MyRecommender"),'action':("myRecommenderByAlbum")],2)
printHtmlPart(26)
createClosureForHtmlPart(27, 2)
invokeTag('link','g',64,['controller':("MyRecommender"),'action':("myRecommenderByArtist")],2)
printHtmlPart(26)
createClosureForHtmlPart(28, 2)
invokeTag('link','g',65,['controller':("MyRecommender"),'action':("myRecommenderByTrack")],2)
printHtmlPart(29)
for( d in (data) ) {
printHtmlPart(30)
...
printHtmlPart(33)
invokeTag('createLinkTo','g',121,['dir':("jquery"),'file':("jquery.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',122,['dir':("jquery"),'file':("jRating.jquery.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',123,['dir':("js"),'file':("bootstrap.min.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',124,['dir':("jquery"),'file':("jquery.tablesorter.pager.js")],-1)
printHtmlPart(35)
})
...
public static final long LAST_MODIFIED = 1417446383000L
