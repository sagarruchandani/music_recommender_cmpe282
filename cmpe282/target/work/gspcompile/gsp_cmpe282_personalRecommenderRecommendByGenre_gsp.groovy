...
class gsp_cmpe282_personalRecommenderRecommendByGenre_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/personalRecommender/RecommendByGenre.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(33)
invokeTag('createLinkTo','g',119,['dir':("jquery"),'file':("jquery.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',120,['dir':("jquery"),'file':("jRating.jquery.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',121,['dir':("js"),'file':("bootstrap.min.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',122,['dir':("jquery"),'file':("jquery.tablesorter.pager.js")],-1)
printHtmlPart(35)
})
...
public static final long LAST_MODIFIED = 1417446154000L
