						...
						<li class="dropdown">
				            ...
				            <ul class="dropdown-menu pull-right">
				               <li><g:link controller="MyRecommender" action="myRecommenderByGenre">By Genre</g:link></li>
				                ...
				                <li class="active"><g:link controller="MyRecommender" action="myRecommenderByTrack">By Track</g:link></li>
				            </ul>
				        </li>
				</ul>
			</div>
			...
			<div class="col-md-9">
				<table width="100%">
					<tr style="padding: 20px; margin: 5px;" id="linearBg2">
						...
						<td class="head">Top Tracks</td>
						
						
						<td class="head">Predicted Ratings</td>
