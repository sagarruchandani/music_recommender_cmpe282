...
class gsp_cmpe282_personalRecommenderRecommendByAlbum_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/personalRecommender/RecommendByAlbum.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(33)
invokeTag('createLinkTo','g',122,['dir':("jquery"),'file':("jquery.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',123,['dir':("jquery"),'file':("jRating.jquery.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',124,['dir':("js"),'file':("bootstrap.min.js")],-1)
printHtmlPart(34)
invokeTag('createLinkTo','g',125,['dir':("jquery"),'file':("jquery.tablesorter.pager.js")],-1)
printHtmlPart(35)
})
...
public static final long LAST_MODIFIED = 1417446116000L
