...
class gsp_cmpe282_personalRecommenderRecommendByArtist_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/personalRecommender/RecommendByArtist.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(34)
invokeTag('createLinkTo','g',120,['dir':("jquery"),'file':("jquery.js")],-1)
printHtmlPart(35)
invokeTag('createLinkTo','g',121,['dir':("jquery"),'file':("jRating.jquery.js")],-1)
printHtmlPart(35)
invokeTag('createLinkTo','g',122,['dir':("js"),'file':("bootstrap.min.js")],-1)
printHtmlPart(35)
invokeTag('createLinkTo','g',123,['dir':("jquery"),'file':("jquery.tablesorter.pager.js")],-1)
printHtmlPart(36)
})
...
public static final long LAST_MODIFIED = 1417446142000L
